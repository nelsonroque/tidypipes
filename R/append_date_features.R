...
#' @param time_features_rounded A logical for rounded time features
#' @param append_rounded A logical value indicating whether to append rounded date timestamps. Defaults to TRUE.
#'
...
#' @importFrom lubridate ymd_hms as_date month day year week hour minute wday round_date
